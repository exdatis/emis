...
type
  ...
  TfrmOfficeMaterial = class(TbaseDbForm)
    ...
    zqProductOM_BARCODE: TStringField;
    zqProductOM_CODE: TStringField;
    zqProductOM_GROUP: TLongintField;
    zqProductOM_ID: TLongintField;
    zqProductOM_MEASURE: TLongintField;
    zqProductOM_NAME: TStringField;
    zqProductOM_PIECES: TFloatField;
    zqProductOM_TAX: TLongintField;
    zqProductTAX_CODE: TStringField;
    zqProductTAX_VALUE: TFloatField;
    zqPropertiesVar: TZQuery;
    zqPropertiesVarOFFICEM_CODE: TStringField;
    zqPropertiesVarOFFICEM_NAME: TStringField;
    zqPropertiesVarOMPROPERTY_NAME: TStringField;
    zqPropertiesVarOPV_ID: TLongintField;
    zqPropertiesVarOPV_OFFICEM: TLongintField;
    zqPropertiesVarOPV_PROPERTY: TLongintField;
    zqPropertiesVarOPV_VALUE: TStringField;
    zroGroups: TZReadOnlyQuery;
    zroGroupsOG_ID: TLongintField;
    zroGroupsOG_NAME: TStringField;
    zroProperties: TZReadOnlyQuery;
    zroMeasure: TZReadOnlyQuery;
    zroMeasureM_ID: TLongintField;
    zroMeasureM_NAME: TStringField;
    zroPropertiesPOO_ID: TLongintField;
    zroPropertiesPOO_NAME: TStringField;
...
var
  frmOfficeMaterial: TfrmOfficeMaterial;
const
  {exception msg}
  ENoProductsMsg : String = 'Nije selektovana/izabrana oprema.';
  //**************************** drugs *****************************************
  {fields of tbl officeMaterial}
  FD_ID : String = 'OM_ID';
  FD_CODE : String = 'OM_CODE';
  FD_NAME : String = 'OM_NAME';
  FD_BARCODE : String = 'OM_BARCODE';
  FD_GROUP : String = 'OM_GROUP';
  FD_MEASURE : String = 'OM_MEASURE';
  FD_TAX : String = 'OM_TAX';
  FD_PIECES : String = 'OM_PIECES';
  ...
  {params}
  PARAM_NAME : String = 'OM_NAME'; {:OM_NAME}

  //****************************************************************************
  {fields of table hequipment_properties_var} //fpv- field_properties_var
  FPV_ID : String = 'OPV_ID';
  FPV_PRODUCT : String = 'OPV_OFFICEM';
  FPV_PROPERTY : String = 'OPV_PROPERTY';
  FPV_VALUE : String = 'OPV_VALUE';
  {fields of view officem_properties_var_v}
  {existent --||-- + property_name}
  PROPERTY_NAME : String = 'OMPROPERTY_NAME';
implementation
uses
  uDModule, uConfirm;
{$R *.lfm}
...
procedure TfrmOfficeMaterial.actCharFilterExecute(Sender: TObject);
begin
  {check current page}
...
procedure TfrmOfficeMaterial.actClearFilterExecute(Sender: TObject);
begin
  {check current page}
  if (not(pcProduct.ActivePageIndex = 0)) then
    begin
...
procedure TfrmOfficeMaterial.cmbFieldArgChange(Sender: TObject);
begin
  {check current page}
  if (not(pcProduct.ActivePageIndex = 0)) then
    begin
...
procedure TfrmOfficeMaterial.dbgProductsMouseMove(Sender: TObject;
...
procedure TfrmOfficeMaterial.dbgProductsTitleClick(Column: TColumn);
var
...
procedure TfrmOfficeMaterial.dbgPropertiesVarMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  {set cursor}
...
procedure TfrmOfficeMaterial.dbgPropertiesVarTitleClick(Column: TColumn);
begin
  {sort}
  doSortDbGrid(TZAbstractDataset(zqPropertiesVar), Column);
end;

procedure TfrmOfficeMaterial.edtLocateEnter(Sender: TObject);
begin
  {check current page}
  if (not(pcProduct.ActivePageIndex = 0)) then
    begin
...
procedure TfrmOfficeMaterial.edtLocateExit(Sender: TObject);
begin
...
procedure TfrmOfficeMaterial.edtLocateKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  {try to locate}
...
procedure TfrmOfficeMaterial.edtLocatePropertyEnter(Sender: TObject);
begin
  {clear text and set font-color}
...
procedure TfrmOfficeMaterial.edtLocatePropertyExit(Sender: TObject);
begin
  {set text and font-color}
...
procedure TfrmOfficeMaterial.edtLocatePropertyKeyUp(Sender: TObject;
...
procedure TfrmOfficeMaterial.FormClose(Sender: TObject;
...
procedure TfrmOfficeMaterial.FormCreate(Sender: TObject);
begin
  {default args}
  charArg:= 'A%';
...
procedure TfrmOfficeMaterial.pcProductChange(Sender: TObject);
var
  recCount, recNo : String;
...
procedure TfrmOfficeMaterial.zqProductAfterDelete(DataSet: TDataSet);
var
  recCount, recNo : String;
  recMsg : String = '0 od 0';
begin
...
procedure TfrmOfficeMaterial.zqProductAfterOpen(DataSet: TDataSet);
var
  recCount, recNo : String;
  recMsg : String = '0 od 0';
begin
...
procedure TfrmOfficeMaterial.zqProductAfterPost(DataSet: TDataSet);
var
  currId : Longint;
  firstChar : String = '';
  currText : String;
...
procedure TfrmOfficeMaterial.zqProductAfterScroll(DataSet: TDataSet);
var
  recCount, recNo : String;
  recMsg : String = '0 od 0';
begin
...
procedure TfrmOfficeMaterial.zqProductBeforeScroll(DataSet: TDataSet);
begin
  {check current page}
  if (not(pcProduct.ActivePageIndex = 0)) then
    begin
...
procedure TfrmOfficeMaterial.zqProductNewRecord(DataSet: TDataSet);
begin
  {set default values}
  TZAbstractDataset(DataSet).FieldByName(FD_PIECES).AsFloat:= 1;
end;

procedure TfrmOfficeMaterial.zqPropertiesVarAfterDelete(DataSet: TDataSet);
var
  recCount, recNo : String;
  recMsg : String = '0 od 0';
begin
...
procedure TfrmOfficeMaterial.zqPropertiesVarAfterOpen(DataSet: TDataSet);
var
  recCount, recNo : String;
  recMsg : String = '0 od 0';
begin
...
procedure TfrmOfficeMaterial.zqPropertiesVarAfterPost(DataSet: TDataSet);
var
  {calc records(recNo and countRec)}
  recCount, recNo : String;
  recMsg : String = '0 od 0';
...
procedure TfrmOfficeMaterial.zqPropertiesVarAfterScroll(DataSet: TDataSet);
var
  recCount, recNo : String;
  recMsg : String = '0 od 0';
begin
...
procedure TfrmOfficeMaterial.zqPropertiesVarBeforeOpen(DataSet: TDataSet);
var
...
procedure TfrmOfficeMaterial.zqPropertiesVarBeforePost(DataSet: TDataSet);
var
  current_product : Integer;
begin
  //find current
...
procedure TfrmOfficeMaterial.saveBeforeClose;
var
  newDlg : TdlgConfirm;
...
procedure TfrmOfficeMaterial.onActFirst;
begin
  {jump to first rec}
  case pcProduct.ActivePageIndex of
...
procedure TfrmOfficeMaterial.onActPrior;
begin
  {jump to prior rec}
  case pcProduct.ActivePageIndex of
...
procedure TfrmOfficeMaterial.onActNext;
begin
  {jump to next rec}
  case pcProduct.ActivePageIndex of
...
procedure TfrmOfficeMaterial.onActLast;
begin
  {jump to last rec}
  case pcProduct.ActivePageIndex of
...
procedure TfrmOfficeMaterial.onActInsert;
begin
...
procedure TfrmOfficeMaterial.onActDelete;
begin
  {delete rec}
  case pcProduct.ActivePageIndex of
...
procedure TfrmOfficeMaterial.onActEdit;
begin
...
procedure TfrmOfficeMaterial.onActSave;
begin
  {save rec}
  case pcProduct.ActivePageIndex of
...
procedure TfrmOfficeMaterial.onActCancel;
begin
  {cancel rec}
  case pcProduct.ActivePageIndex of
...
procedure TfrmOfficeMaterial.openRODataSets;
begin
  //product groups
...
procedure TfrmOfficeMaterial.applyCharFilter;
begin
