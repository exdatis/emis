...
uses
  ...
  ComCtrls, ExtCtrls, LCLIntf, StdCtrls, Buttons, process, IniFiles, strutils;
...
uses
  ...
  uHygieneMaterial, uSServicesGroups, uSupplyServices, uLogin;
{$R *.lfm}
...
function TfrmGeneral.checkUser(const ini_file: String): Boolean;
const
