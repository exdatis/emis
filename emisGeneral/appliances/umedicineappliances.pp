...
type
  ...
  { TfrmMedicineAppliances }

  TfrmMedicineAppliances = class(TbaseDbForm)
    ...
    zqPropertiesVarAPPLIANCE_CODE: TStringField;
    zqPropertiesVarAPPLIANCE_NAME: TStringField;
    zqPropertiesVarMPV_APPLIANCE: TLongintField;
    ...
    zroGroupsAG_ID: TLongintField;
    zroGroupsAG_NAME: TStringField;
    zroProperties: TZReadOnlyQuery;
    zroMeasure: TZReadOnlyQuery;
    zroMeasureM_ID: TLongintField;
    zroMeasureM_NAME: TStringField;
    zroPropertiesPOA_ID: TLongintField;
    zroPropertiesPOA_NAME: TStringField;
...
var
  frmMedicineAppliances: TfrmMedicineAppliances;
const
  {exception msg}
  ENoProductsMsg : String = 'Nije selektovan/izabran aparat.';
  //**************************** drugs *****************************************
  {fields of tbl medicineAppliances}
  FD_ID : String = 'MA_ID';
  ...
  {fields of view medicine_appliances_v}
  ...
  //****************************************************************************
  {fields of table mappliances_properties_var} //fpv- field_properties_var
  FPV_ID : String = 'MPV_ID';
  FPV_PRODUCT : String = 'MPV_APPLIANCE';
...
procedure TfrmMedicineAppliances.actCharFilterExecute(Sender: TObject);
begin
  {check current page}
...
procedure TfrmMedicineAppliances.actClearFilterExecute(Sender: TObject);
begin
  {check current page}
  if (not(pcProduct.ActivePageIndex = 0)) then
    begin
  ...
  cmbCharFilter.Text:= 'Aparati na slovo ...'; {message like text}
end;

procedure TfrmMedicineAppliances.cmbFieldArgChange(Sender: TObject);
begin
  {check current page}
  if (not(pcProduct.ActivePageIndex = 0)) then
    begin
...
procedure TfrmMedicineAppliances.dbgProductsMouseMove(Sender: TObject;
...
procedure TfrmMedicineAppliances.dbgProductsTitleClick(Column: TColumn);
var
...
procedure TfrmMedicineAppliances.dbgPropertiesVarMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  {set cursor}
...
procedure TfrmMedicineAppliances.dbgPropertiesVarTitleClick(Column: TColumn);
begin
  {sort}
  doSortDbGrid(TZAbstractDataset(zqPropertiesVar), Column);
end;

procedure TfrmMedicineAppliances.edtLocateEnter(Sender: TObject);
begin
  {check current page}
  if (not(pcProduct.ActivePageIndex = 0)) then
    begin
...
procedure TfrmMedicineAppliances.edtLocateExit(Sender: TObject);
begin
...
procedure TfrmMedicineAppliances.edtLocateKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  {try to locate}
...
procedure TfrmMedicineAppliances.edtLocatePropertyEnter(Sender: TObject);
begin
  {clear text and set font-color}
...
procedure TfrmMedicineAppliances.edtLocatePropertyExit(Sender: TObject);
begin
  {set text and font-color}
...
procedure TfrmMedicineAppliances.edtLocatePropertyKeyUp(Sender: TObject;
...
procedure TfrmMedicineAppliances.FormClose(Sender: TObject;
...
procedure TfrmMedicineAppliances.FormCreate(Sender: TObject);
begin
  {default args}
  charArg:= 'A%';
...
procedure TfrmMedicineAppliances.pcProductChange(Sender: TObject);
var
  recCount, recNo : String;
...
procedure TfrmMedicineAppliances.zqProductAfterDelete(DataSet: TDataSet);
var
  recCount, recNo : String;
  recMsg : String = '0 od 0';
begin
...
procedure TfrmMedicineAppliances.zqProductAfterOpen(DataSet: TDataSet);
var
  recCount, recNo : String;
  recMsg : String = '0 od 0';
begin
...
procedure TfrmMedicineAppliances.zqProductAfterPost(DataSet: TDataSet);
var
  currId : Longint;
  firstChar : String = '';
  currText : String;
...
procedure TfrmMedicineAppliances.zqProductAfterScroll(DataSet: TDataSet);
var
  recCount, recNo : String;
  recMsg : String = '0 od 0';
begin
...
procedure TfrmMedicineAppliances.zqProductBeforeScroll(DataSet: TDataSet);
begin
  {check current page}
  if (not(pcProduct.ActivePageIndex = 0)) then
    begin
...
procedure TfrmMedicineAppliances.zqProductNewRecord(DataSet: TDataSet);
begin
  {set default values}
  TZAbstractDataset(DataSet).FieldByName(FD_PIECES).AsFloat:= 1;
end;

procedure TfrmMedicineAppliances.zqPropertiesVarAfterDelete(DataSet: TDataSet);
var
  recCount, recNo : String;
  recMsg : String = '0 od 0';
begin
...
procedure TfrmMedicineAppliances.zqPropertiesVarAfterOpen(DataSet: TDataSet);
var
  recCount, recNo : String;
  recMsg : String = '0 od 0';
begin
...
procedure TfrmMedicineAppliances.zqPropertiesVarAfterPost(DataSet: TDataSet);
var
  {calc records(recNo and countRec)}
  recCount, recNo : String;
  recMsg : String = '0 od 0';
...
procedure TfrmMedicineAppliances.zqPropertiesVarAfterScroll(DataSet: TDataSet);
var
  recCount, recNo : String;
  recMsg : String = '0 od 0';
begin
...
procedure TfrmMedicineAppliances.zqPropertiesVarBeforeOpen(DataSet: TDataSet);
var
...
procedure TfrmMedicineAppliances.zqPropertiesVarBeforePost(DataSet: TDataSet);
var
  current_product : Integer;
begin
  //find current
...
procedure TfrmMedicineAppliances.saveBeforeClose;
var
  newDlg : TdlgConfirm;
...
procedure TfrmMedicineAppliances.onActFirst;
begin
  {jump to first rec}
  case pcProduct.ActivePageIndex of
...
procedure TfrmMedicineAppliances.onActPrior;
begin
  {jump to prior rec}
  case pcProduct.ActivePageIndex of
...
procedure TfrmMedicineAppliances.onActNext;
begin
  {jump to next rec}
  case pcProduct.ActivePageIndex of
...
procedure TfrmMedicineAppliances.onActLast;
begin
  {jump to last rec}
  case pcProduct.ActivePageIndex of
...
procedure TfrmMedicineAppliances.onActInsert;
begin
...
procedure TfrmMedicineAppliances.onActDelete;
begin
  {delete rec}
  case pcProduct.ActivePageIndex of
...
procedure TfrmMedicineAppliances.onActEdit;
begin
...
procedure TfrmMedicineAppliances.onActSave;
begin
  {save rec}
  case pcProduct.ActivePageIndex of
...
procedure TfrmMedicineAppliances.onActCancel;
begin
  {cancel rec}
  case pcProduct.ActivePageIndex of
...
procedure TfrmMedicineAppliances.openRODataSets;
begin
  //product groups
  ...
  //property(of medicine appliances)
  zroProperties.DisableControls;
  zroProperties.Open;
  zroProperties.EnableControls;
end;

procedure TfrmMedicineAppliances.applyCharFilter;
begin
