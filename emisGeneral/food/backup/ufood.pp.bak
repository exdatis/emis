...
type
  ...
  TfrmFood = class(TbaseDbForm)
    ...
    zqProduct: TZQuery;
    zqProductF_BARCODE: TStringField;
    zqProductF_CODE: TStringField;
    zqProductF_GROUP: TLongintField;
    zqProductF_ID: TLongintField;
    zqProductF_MEASURE: TLongintField;
    zqProductF_NAME: TStringField;
    zqProductF_PIECES: TFloatField;
    zqProductF_TAX: TLongintField;
    ...
    zqPropertiesVarFOOD_CODE: TStringField;
    zqPropertiesVarFOOD_NAME: TStringField;
    zqPropertiesVarFPROPERTY_NAME: TStringField;
    zqPropertiesVarFPV_FOOD: TLongintField;
    zqPropertiesVarFPV_ID: TLongintField;
    zqPropertiesVarFPV_PROPERTY: TLongintField;
    zqPropertiesVarFPV_VALUE: TStringField;
    zroGroups: TZReadOnlyQuery;
    zroGroupsFG_ID: TLongintField;
    zroGroupsFG_NAME: TStringField;
    zroProperties: TZReadOnlyQuery;
    zroMeasure: TZReadOnlyQuery;
    zroMeasureM_ID: TLongintField;
    zroMeasureM_NAME: TStringField;
    zroPropertiesPOF_ID: TLongintField;
    zroPropertiesPOF_NAME: TStringField;
...
const
  {exception msg}
  ENoProductsMsg : String = 'Nije selektovana/izabrana hrana.';
  //**************************** drugs *****************************************
  {fields of tbl food}
  FD_ID : String = 'F_ID';
  FD_CODE : String = 'F_CODE';
  FD_NAME : String = 'F_NAME';
  FD_BARCODE : String = 'F_BARCODE';
  FD_GROUP : String = 'F_GROUP';
  FD_MEASURE : String = 'F_MEASURE';
  FD_TAX : String = 'F_TAX';
  FD_PIECES : String = 'F_PIECES';
  {fields of view food_v}
  ...
  {params}
  PARAM_NAME : String = 'F_NAME'; {:F_NAME}

  //****************************************************************************
  {fields of table food_properties_var} //fpv- field_properties_var
  FPV_ID : String = 'FPV_ID';
  FPV_PRODUCT : String = 'FPV_FOOD';
  FPV_PROPERTY : String = 'FPV_PROPERTY';
  FPV_VALUE : String = 'FPV_VALUE';
  {fields of view food_properties_var_v}
  {existent --||-- + property_name}
  PROPERTY_NAME : String = 'FPROPERTY_NAME';
implementation
uses
  uDModule, uConfirm;
{$R *.lfm}
...
procedure TfrmFood.actCharFilterExecute(Sender: TObject);
begin
  {check current page}
...
procedure TfrmFood.actClearFilterExecute(Sender: TObject);
begin
  {check current page}
  if (not(pcProduct.ActivePageIndex = 0)) then
    begin
  ...
  cmbCharFilter.Text:= 'Hrana na slovo ...'; {message like text}
end;

procedure TfrmFood.cmbFieldArgChange(Sender: TObject);
begin
  {check current page}
  if (not(pcProduct.ActivePageIndex = 0)) then
    begin
...
procedure TfrmFood.dbgProductsMouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
  {set cursor again}
...
procedure TfrmFood.dbgProductsTitleClick(Column: TColumn);
var
...
procedure TfrmFood.dbgPropertiesVarMouseMove(Sender: TObject;
...
procedure TfrmFood.dbgPropertiesVarTitleClick(Column: TColumn);
begin
  {sort}
  doSortDbGrid(TZAbstractDataset(zqPropertiesVar), Column);
end;

procedure TfrmFood.edtLocateEnter(Sender: TObject);
begin
  {check current page}
  if (not(pcProduct.ActivePageIndex = 0)) then
    begin
...
procedure TfrmFood.edtLocateExit(Sender: TObject);
begin
...
procedure TfrmFood.edtLocateKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  {try to locate}
...
procedure TfrmFood.edtLocatePropertyEnter(Sender: TObject);
begin
  {clear text and set font-color}
...
procedure TfrmFood.edtLocatePropertyExit(Sender: TObject);
begin
  {set text and font-color}
...
procedure TfrmFood.edtLocatePropertyKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  {try to locate}
...
procedure TfrmFood.FormClose(Sender: TObject; var CloseAction: TCloseAction);
begin
...
procedure TfrmFood.pcProductChange(Sender: TObject);
var
  recCount, recNo : String;
...
procedure TfrmFood.zqProductAfterDelete(DataSet: TDataSet);
var
  recCount, recNo : String;
  recMsg : String = '0 od 0';
begin
...
procedure TfrmFood.zqProductAfterOpen(DataSet: TDataSet);
var
  recCount, recNo : String;
  recMsg : String = '0 od 0';
begin
...
procedure TfrmFood.zqProductAfterPost(DataSet: TDataSet);
var
  currId : Longint;
  firstChar : String = '';
  currText : String;
...
procedure TfrmFood.zqProductAfterScroll(DataSet: TDataSet);
var
  recCount, recNo : String;
  recMsg : String = '0 od 0';
begin
...
procedure TfrmFood.zqProductBeforeScroll(DataSet: TDataSet);
begin
  {check current page}
  if (not(pcProduct.ActivePageIndex = 0)) then
    begin
...
procedure TfrmFood.zqProductNewRecord(DataSet: TDataSet);
begin
  {set default values}
  TZAbstractDataset(DataSet).FieldByName(FD_PIECES).AsFloat:= 1;
end;

procedure TfrmFood.zqPropertiesVarAfterDelete(DataSet: TDataSet);
var
  recCount, recNo : String;
  recMsg : String = '0 od 0';
begin
...
procedure TfrmFood.zqPropertiesVarAfterOpen(DataSet: TDataSet);
var
  recCount, recNo : String;
  recMsg : String = '0 od 0';
begin
...
procedure TfrmFood.zqPropertiesVarAfterPost(DataSet: TDataSet);
var
  {calc records(recNo and countRec)}
  recCount, recNo : String;
  recMsg : String = '0 od 0';
...
procedure TfrmFood.zqPropertiesVarAfterScroll(DataSet: TDataSet);
var
  recCount, recNo : String;
  recMsg : String = '0 od 0';
begin
...
procedure TfrmFood.zqPropertiesVarBeforeOpen(DataSet: TDataSet);
var
...
procedure TfrmFood.zqPropertiesVarBeforePost(DataSet: TDataSet);
var
  current_product : Integer;
begin
  //find current
...
procedure TfrmFood.saveBeforeClose;
var
  newDlg : TdlgConfirm;
...
procedure TfrmFood.onActInsert;
begin
...
procedure TfrmFood.onActDelete;
begin
  {delete rec}
  case pcProduct.ActivePageIndex of
...
procedure TfrmFood.onActCancel;
begin
  {cancel rec}
  case pcProduct.ActivePageIndex of
...
procedure TfrmFood.openRODataSets;
begin
  //product groups
...
procedure TfrmFood.applyCharFilter;
begin
