...
type
  ...
  { TfrmPropertiesOfHEquipment }

  TfrmPropertiesOfHEquipment = class(TbaseDbForm)
    dbCode: TDBEdit;
    ...
    ztProperty: TZTable;
    ztPropertyPOH_CODE: TStringField;
    ztPropertyPOH_ID: TLongintField;
    ztPropertyPOH_NAME: TStringField;
...
var
  frmPropertiesOfHEquipment: TfrmPropertiesOfHEquipment;
const
  {fields of tbl propertiesOfHEquipment}
  FP_ID : String = 'POH_ID';
  FP_CODE : String = 'POH_CODE';
  FP_NAME : String = 'POH_NAME';
implementation
uses
  uDModule, uConfirm;
{$R *.lfm}
...
procedure TfrmPropertiesOfHEquipment.dbgPropertiesMouseMove(Sender: TObject;
...
procedure TfrmPropertiesOfHEquipment.dbgPropertiesTitleClick(Column: TColumn);
var
...
procedure TfrmPropertiesOfHEquipment.edtLocateEnter(Sender: TObject);
begin
...
procedure TfrmPropertiesOfHEquipment.edtLocateExit(Sender: TObject);
begin
...
procedure TfrmPropertiesOfHEquipment.edtLocateKeyUp(Sender: TObject;
...
procedure TfrmPropertiesOfHEquipment.FormClose(Sender: TObject;
...
procedure TfrmPropertiesOfHEquipment.ztPropertyAfterDelete(DataSet: TDataSet);
var
  recCount, recNo : String;
...
procedure TfrmPropertiesOfHEquipment.ztPropertyAfterOpen(DataSet: TDataSet);
var
  recCount, recNo : String;
  recMsg : String = '0 od 0';
begin
...
procedure TfrmPropertiesOfHEquipment.ztPropertyAfterPost(DataSet: TDataSet);
var
...
procedure TfrmPropertiesOfHEquipment.ztPropertyAfterScroll(DataSet: TDataSet);
var
  recCount, recNo : String;
  recMsg : String = '0 od 0';
begin
...
procedure TfrmPropertiesOfHEquipment.saveBeforeClose;
var
  newDlg : TdlgConfirm;
...
procedure TfrmPropertiesOfHEquipment.onActFirst;
begin
  {jump to first rec}
  doFirstRec(TZAbstractDataset(ztProperty));
end;

procedure TfrmPropertiesOfHEquipment.onActPrior;
begin
  {jump to prior rec}
  doPriorRec(TZAbstractDataset(ztProperty));
end;

procedure TfrmPropertiesOfHEquipment.onActNext;
begin
  {jump to next rec}
  doNextRec(TZAbstractDataset(ztProperty));
end;

procedure TfrmPropertiesOfHEquipment.onActLast;
begin
  {jump to last rec}
  doLastRec(TZAbstractDataset(ztProperty));
end;

procedure TfrmPropertiesOfHEquipment.onActInsert;
begin
...
procedure TfrmPropertiesOfHEquipment.onActDelete;
begin
  {delete rec}
  doDeleteRec(TZAbstractDataset(ztProperty));
end;

procedure TfrmPropertiesOfHEquipment.onActEdit;
begin
...
procedure TfrmPropertiesOfHEquipment.onActSave;
begin
  {save rec}
  doSaveRec(TZAbstractDataset(ztProperty));
end;

procedure TfrmPropertiesOfHEquipment.onActCancel;
begin
  {cancel rec}
  doCancelRec(TZAbstractDataset(ztProperty));
end;

procedure TfrmPropertiesOfHEquipment.openDataSet;
begin
