...
procedure TfrmFoodWarehouse.edtGridSearchKeyDown(Sender: TObject;
...
procedure TfrmFoodWarehouse.edtGridSearchKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  {try to locate}
...
procedure TfrmFoodWarehouse.edtLocateEnter(Sender: TObject);
begin
...
procedure TfrmFoodWarehouse.edtLocateExit(Sender: TObject);
begin
...
procedure TfrmFoodWarehouse.edtLocateKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  {try to locate}
...
procedure TfrmFoodWarehouse.dbgLocationKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  {Ctrl+space to use this result}
  if (ssCtrl in Shift)and (Key = VK_SPACE) then
