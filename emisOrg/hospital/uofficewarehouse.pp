...
procedure TfrmOfficeWarehouse.dbgLocationKeyDown(Sender: TObject;
...
procedure TfrmOfficeWarehouse.edtGridSearchKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  {Escape to exit}
...
procedure TfrmOfficeWarehouse.edtGridSearchKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  {try to locate}
...
procedure TfrmOfficeWarehouse.edtLocateEnter(Sender: TObject);
begin
...
procedure TfrmOfficeWarehouse.edtLocateExit(Sender: TObject);
begin
...
procedure TfrmOfficeWarehouse.edtLocateKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  {try to locate}
