...
procedure TfrmHEquipmentWarehouse.dbgLocationKeyDown(Sender: TObject;
...
procedure TfrmHEquipmentWarehouse.edtGridSearchKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  {Escape to exit}
...
procedure TfrmHEquipmentWarehouse.edtGridSearchKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  {try to locate}
