...
type
  ...
  { TfrmAppliancesHPWarehouse }

  TfrmAppliancesHPWarehouse = class(TbaseDbForm)
    actFind: TActionList;
    ...
    zqWarehouse: TZQuery;
    zqWarehouseAHPW_ADDRESS: TStringField;
    zqWarehouseAHPW_CODE: TStringField;
    zqWarehouseAHPW_DEPARTMENT: TLongintField;
    zqWarehouseAHPW_FAX: TStringField;
    zqWarehouseAHPW_ID: TLongintField;
    zqWarehouseAHPW_LOCATION: TLongintField;
    zqWarehouseAHPW_MAIL: TStringField;
    zqWarehouseAHPW_NAME: TStringField;
    zqWarehouseAHPW_PHONE: TStringField;
...
var
  frmAppliancesHPWarehouse: TfrmAppliancesHPWarehouse;
const
  EMPTY_SET : String = 'Prazan skup podataka.';
  {fields of tbl AppliancesHPWarehouse(FW -> fields Warehouse) and view(appliances_hpwarehouse_v)}
  FW_ID : String = 'AHPW_ID';
  FW_CODE : String = 'AHPW_CODE';
  FW_NAME : String = 'AHPW_NAME';
  FW_LOCATION : String = 'AHPW_LOCATION';
  FW_ADDRESS : String = 'AHPW_ADDRESS';
  FW_PHONE : String = 'AHPW_PHONE';
  FW_FAX : String = 'AHPW_FAX';
  FW_MAIL : String = 'AHPW_MAIL';
  //VIEW  APPLIANCES_HPWAREHOUSE_V
...
procedure TfrmAppliancesHPWarehouse.FormCreate(Sender: TObject);
begin
  {default arg - location(NAME)}
  locationArg:= FW_LOCATION_NAME;
end;

procedure TfrmAppliancesHPWarehouse.dbgWarehouseMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  dbgWarehouse.Cursor:= crHandPoint;
end;

procedure TfrmAppliancesHPWarehouse.actFindLocationByCodeExecute(Sender: TObject
  );
begin
...
procedure TfrmAppliancesHPWarehouse.actFindLocationByNameExecute(Sender: TObject
  );
begin
...
procedure TfrmAppliancesHPWarehouse.btnFindLocationClick(Sender: TObject);
begin
  {show popUpMnu}
  pupFindLocation.PopUp(Mouse.CursorPos.x, Mouse.CursorPos.y);
end;

procedure TfrmAppliancesHPWarehouse.btnLocationCancelClick(Sender: TObject);
begin
...
procedure TfrmAppliancesHPWarehouse.btnLocationOkClick(Sender: TObject);
begin
  {use current location}
  useThisLocation;
end;

procedure TfrmAppliancesHPWarehouse.dbgLocationKeyDown(Sender: TObject;
...
procedure TfrmAppliancesHPWarehouse.dbgLocationMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  dbgLocation.Cursor:= crHandPoint;
end;

procedure TfrmAppliancesHPWarehouse.dbgLocationTitleClick(Column: TColumn);
begin
  doSortDbGrid(TZAbstractDataset(TZAbstractRODataset(zroFindLocation)), Column);
end;

procedure TfrmAppliancesHPWarehouse.dbgWarehouseTitleClick(Column: TColumn);
var
...
procedure TfrmAppliancesHPWarehouse.dbLocationKeyPress(Sender: TObject;
  var Key: char);
begin
  {on pres Return}
  if(Key = #13) then
...
procedure TfrmAppliancesHPWarehouse.edtGridSearchKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  {Escape to exit}
...
procedure TfrmAppliancesHPWarehouse.edtGridSearchKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  {try to locate}
...
procedure TfrmAppliancesHPWarehouse.edtLocateEnter(Sender: TObject);
begin
...
procedure TfrmAppliancesHPWarehouse.edtLocateExit(Sender: TObject);
begin
...
procedure TfrmAppliancesHPWarehouse.edtLocateKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  {try to locate}
...
procedure TfrmAppliancesHPWarehouse.FormClose(Sender: TObject;
...
procedure TfrmAppliancesHPWarehouse.zqWarehouseAfterDelete(DataSet: TDataSet);
var
  recCount, recNo : String;
...
procedure TfrmAppliancesHPWarehouse.zqWarehouseAfterOpen(DataSet: TDataSet);
var
  recCount, recNo : String;
  recMsg : String = '0 od 0';
begin
...
procedure TfrmAppliancesHPWarehouse.zqWarehouseAfterPost(DataSet: TDataSet);
var
...
procedure TfrmAppliancesHPWarehouse.zqWarehouseAfterScroll(DataSet: TDataSet);
var
  recCount, recNo : String;
  recMsg : String = '0 od 0';
begin
...
procedure TfrmAppliancesHPWarehouse.saveBeforeClose;
var
  newDlg : TdlgConfirm;
...
procedure TfrmAppliancesHPWarehouse.findLocation(textArg: String);
var
...
procedure TfrmAppliancesHPWarehouse.useThisLocation;
begin
...
procedure TfrmAppliancesHPWarehouse.onActFirst;
begin
  {jump to first rec}
  doFirstRec(TZAbstractDataset(zqWarehouse));
end;

procedure TfrmAppliancesHPWarehouse.onActPrior;
begin
  {jump to prior rec}
  doPriorRec(TZAbstractDataset(zqWarehouse));
end;

procedure TfrmAppliancesHPWarehouse.onActNext;
begin
  {jump to next rec}
  doNextRec(TZAbstractDataset(zqWarehouse));
end;

procedure TfrmAppliancesHPWarehouse.onActLast;
begin
  {jump to last rec}
  doLastRec(TZAbstractDataset(zqWarehouse));
end;

procedure TfrmAppliancesHPWarehouse.onActInsert;
begin
...
procedure TfrmAppliancesHPWarehouse.onActDelete;
begin
  {delete rec}
  doDeleteRec(TZAbstractDataset(zqWarehouse));
end;

procedure TfrmAppliancesHPWarehouse.onActEdit;
begin
...
procedure TfrmAppliancesHPWarehouse.onActSave;
begin
  {save rec}
  doSaveRec(TZAbstractDataset(zqWarehouse));
end;

procedure TfrmAppliancesHPWarehouse.onActCancel;
begin
  {hide panel}
  if(edtGridSearch.Visible) then
    edtGridSearch.Visible:= False;
...
procedure TfrmAppliancesHPWarehouse.openDataSet;
begin
