...
procedure TfrmHEquipmentHPWarehouse.edtLocateEnter(Sender: TObject);
begin
...
procedure TfrmHEquipmentHPWarehouse.edtLocateExit(Sender: TObject);
begin
...
procedure TfrmHEquipmentHPWarehouse.edtLocateKeyUp(Sender: TObject;
