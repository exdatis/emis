...
type
  ...
  { TfrmAppliancesWarehouse }

  TfrmAppliancesWarehouse = class(TbaseDbForm)
    actFind: TActionList;
    ...
    zqWarehouse: TZQuery;
    zqWarehouseAW_ADDRESS: TStringField;
    zqWarehouseAW_CODE: TStringField;
    zqWarehouseAW_DEPARTMENT: TLongintField;
    zqWarehouseAW_FAX: TStringField;
    zqWarehouseAW_ID: TLongintField;
    zqWarehouseAW_LOCATION: TLongintField;
    zqWarehouseAW_MAIL: TStringField;
    zqWarehouseAW_NAME: TStringField;
    zqWarehouseAW_PHONE: TStringField;
...
var
  frmAppliancesWarehouse: TfrmAppliancesWarehouse;
const
  EMPTY_SET : String = 'Prazan skup podataka.';
  {fields of tbl AppliancesWarehouse(FW -> fields Warehouse) and view(appliances_warehouse_v)}
  FW_ID : String = 'AW_ID';
  FW_CODE : String = 'AW_CODE';
  FW_NAME : String = 'AW_NAME';
  FW_LOCATION : String = 'AW_LOCATION';
  FW_ADDRESS : String = 'AW_ADDRESS';
  FW_PHONE : String = 'AW_PHONE';
  FW_FAX : String = 'AW_FAX';
  FW_MAIL : String = 'AW_MAIL';
...
procedure TfrmAppliancesWarehouse.FormCreate(Sender: TObject);
begin
  {default arg - location(NAME)}
  locationArg:= FW_LOCATION_NAME;
end;

procedure TfrmAppliancesWarehouse.dbgWarehouseMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  dbgWarehouse.Cursor:= crHandPoint;
end;

procedure TfrmAppliancesWarehouse.actFindLocationByCodeExecute(Sender: TObject);
begin
  locationArg:= FW_ZIP_CODE; //set search arg
  findLocation(dbLocation.Text); //set text arg
end;

procedure TfrmAppliancesWarehouse.actFindLocationByNameExecute(Sender: TObject);
begin
  locationArg:= FW_LOCATION_NAME; //set search arg
  findLocation(dbLocation.Text); //set text arg
end;

procedure TfrmAppliancesWarehouse.btnFindLocationClick(Sender: TObject);
begin
  {show popUpMnu}
  pupFindLocation.PopUp(Mouse.CursorPos.x, Mouse.CursorPos.y);
end;

procedure TfrmAppliancesWarehouse.btnLocationCancelClick(Sender: TObject);
begin
...
procedure TfrmAppliancesWarehouse.btnLocationOkClick(Sender: TObject);
begin
  {use current location}
  useThisLocation;
end;

procedure TfrmAppliancesWarehouse.dbgLocationKeyDown(Sender: TObject;
...
procedure TfrmAppliancesWarehouse.dbgLocationMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
  dbgLocation.Cursor:= crHandPoint;
end;

procedure TfrmAppliancesWarehouse.dbgLocationTitleClick(Column: TColumn);
begin
  doSortDbGrid(TZAbstractDataset(TZAbstractRODataset(zroFindLocation)), Column);
end;

procedure TfrmAppliancesWarehouse.dbgWarehouseTitleClick(Column: TColumn);
var
...
procedure TfrmAppliancesWarehouse.dbLocationKeyPress(Sender: TObject;
  var Key: char);
begin
  {on pres Return}
  if(Key = #13) then
...
procedure TfrmAppliancesWarehouse.edtGridSearchKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  {Escape to exit}
...
procedure TfrmAppliancesWarehouse.edtGridSearchKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  {try to locate}
...
procedure TfrmAppliancesWarehouse.edtLocateEnter(Sender: TObject);
begin
...
procedure TfrmAppliancesWarehouse.edtLocateExit(Sender: TObject);
begin
...
procedure TfrmAppliancesWarehouse.edtLocateKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  {try to locate}
...
procedure TfrmAppliancesWarehouse.FormClose(Sender: TObject;
...
procedure TfrmAppliancesWarehouse.zqWarehouseAfterDelete(DataSet: TDataSet);
var
  recCount, recNo : String;
...
procedure TfrmAppliancesWarehouse.zqWarehouseAfterOpen(DataSet: TDataSet);
var
  recCount, recNo : String;
  recMsg : String = '0 od 0';
begin
...
procedure TfrmAppliancesWarehouse.zqWarehouseAfterPost(DataSet: TDataSet);
var
...
procedure TfrmAppliancesWarehouse.zqWarehouseAfterScroll(DataSet: TDataSet);
var
  recCount, recNo : String;
  recMsg : String = '0 od 0';
begin
...
procedure TfrmAppliancesWarehouse.saveBeforeClose;
var
  newDlg : TdlgConfirm;
...
procedure TfrmAppliancesWarehouse.findLocation(textArg: String);
var
...
procedure TfrmAppliancesWarehouse.useThisLocation;
begin
...
procedure TfrmAppliancesWarehouse.onActFirst;
begin
  {jump to first rec}
  doFirstRec(TZAbstractDataset(zqWarehouse));
end;

procedure TfrmAppliancesWarehouse.onActPrior;
begin
  {jump to prior rec}
  doPriorRec(TZAbstractDataset(zqWarehouse));
end;

procedure TfrmAppliancesWarehouse.onActNext;
begin
  {jump to next rec}
  doNextRec(TZAbstractDataset(zqWarehouse));
end;

procedure TfrmAppliancesWarehouse.onActLast;
begin
  {jump to last rec}
  doLastRec(TZAbstractDataset(zqWarehouse));
end;

procedure TfrmAppliancesWarehouse.onActInsert;
begin
...
procedure TfrmAppliancesWarehouse.onActDelete;
begin
  {delete rec}
  doDeleteRec(TZAbstractDataset(zqWarehouse));
end;

procedure TfrmAppliancesWarehouse.onActEdit;
begin
...
procedure TfrmAppliancesWarehouse.onActSave;
begin
  {save rec}
  doSaveRec(TZAbstractDataset(zqWarehouse));
end;

procedure TfrmAppliancesWarehouse.onActCancel;
begin
  {hide panel}
  if(edtGridSearch.Visible) then
    edtGridSearch.Visible:= False;
...
procedure TfrmAppliancesWarehouse.openDataSet;
begin
