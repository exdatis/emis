...
procedure TfrmHygieneWarehouse.dbgLocationKeyDown(Sender: TObject;
...
procedure TfrmHygieneWarehouse.edtGridSearchKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  {Escape to exit}
...
procedure TfrmHygieneWarehouse.edtGridSearchKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  {try to locate}
...
procedure TfrmHygieneWarehouse.edtLocateEnter(Sender: TObject);
begin
...
procedure TfrmHygieneWarehouse.edtLocateExit(Sender: TObject);
begin
...
procedure TfrmHygieneWarehouse.edtLocateKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  {try to locate}
